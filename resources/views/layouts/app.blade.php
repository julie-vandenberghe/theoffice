...
<body class="font-[Nunito] flex flex-col justify-between h-screen">
    <div class="bg-blue-800 text-white py-8 shadow-xl">
        <div class="max-w-5xl mx-auto px-3">
            <div class="flex justify-between items-center">
                ...
                <nav class="space-x-3">
                    ...
                    <a class="hover:underline underline-offset-8" href="/matelas">Nos Salles</a>
                    <a class="hover:underline underline-offset-8" href="/marques">Nos Utilisateurs</a>
    ...
    <footer class="bg-blue-800 text-white py-8">
        <div class="max-w-5xl mx-auto px-3">
            <p class="text-center text-xl">The Office &copy; {{ date('Y') }}</p>
        </div>
    </footer>
</body>
</html>